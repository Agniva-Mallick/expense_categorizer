...
def _generate_synthetic_expenses(n: int=100000) -> list[str]:
    categories = {'Food': ['MCDONALDS', 'STARBUCKS', 'CHIPOTLE', 'UBER EATS', 'DOORDASH', 'TST* SWEETGREEN', 'WHOLEFDS', "TRADER JOE'S", 'KFC', 'PIZZA HUT'], 'Transportation': ['UBER *TRIP', 'LYFT', 'CHEVRON', 'SHELL OIL', 'EXXONMOBIL', 'MTA*NYCT PAYGO', 'BART-DALY CITY', 'PARKING METER', 'TFL TRAVEL CHARGE'], 'Utilities': ['COMCAST', 'AT&T', 'VERIZON WIRELESS', 'PG&E', 'CON EDISON', 'T-MOBILE', 'WATER DEPT', 'CITY OF LA UTIL'], 'Entertainment': ['NETFLIX.COM', 'SPOTIFY', 'HULU', 'STEAM GAMES', 'PLAYSTATION', 'AMC THEATRES', 'DISNEY PLUS', 'TICKETMASTER'], 'Shopping': ['AMZN Mktp US', 'AMAZON.COM', 'TARGET', 'WALMART', 'APPLE.COM/BILL', 'HOME DEPOT', 'BEST BUY', 'IKEA', 'COSTCO WHSE'], 'Income': ['DIRECT DEP', 'PAYROLL', 'VENMO CASHOUT', 'ZELLE TRANSFER', 'PAYPAL TRANSFER', 'CASH APP', 'DIVIDEND'], 'Housing': ['RENT PAYMENT', 'MORTGAGE', 'HOA DUES', 'HOME INSR', 'APT LEASING'], 'Health': ['CVS/PHARMACY', 'WALGREENS', 'KAISER PERMANENTE', 'QUEST DIAGNOSTICS', 'DENTAL CARE', 'VISION CENTER']}
